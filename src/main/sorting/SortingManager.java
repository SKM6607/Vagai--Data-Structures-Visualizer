...
import java.awt.*;
import java.util.*;
public final class SortingManager extends JPanel implements MacroInterface, GridInterface {
    ...
    private final Runnable[] sortingAlgorithms = new Runnable[]{
    ...
    private void swapHeights(ArrayList<ArrayBlock> arrayList, int i0, int i1) {
