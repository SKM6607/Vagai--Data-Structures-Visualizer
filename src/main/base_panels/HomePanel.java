...
public class HomePanel extends JPanel {
    ...
    private static HomePanel singleton;
    ...
    private HomePanel(JPanel parent) {
        setLayout(null);
    ...
    public static @NotNull HomePanel getInstance(JPanel parent) {
        return (singleton == null) ? singleton = new HomePanel(parent) : singleton;
    }
